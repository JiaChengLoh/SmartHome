...
import my.edu.tarc.smarthome.ui.reminder.ReminderFragment.Toast.displayFailureToast
import my.edu.tarc.smarthome.ui.reminder.ReminderFragment.Toast.displaySuccessToast
...
class ReminderFragment : Fragment(), KodeinAware {
    ...
    override fun onCreateOptionsMenu(menu: Menu, inflater: MenuInflater) {
        inflater.inflate(R.menu.reminder_menu_items, menu)
